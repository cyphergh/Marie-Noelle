						...
						<div class="form-grids row widget-shadow" data-example-id="basic-forms">
							...
							<div class="form-body">
								<form method="post" class="row">
									...
									<?php
									$cid = $_GET['editid'];
									$ret = mysqli_query($con, "select * from  tbl_staff where id ='$cid'");
									$cnt = 1;
									while ($row = mysqli_fetch_array($ret)) {
										...
										<div class="form-group col-md-6"> <label>Email</label> <input class="form-control"
												name="email" id="email" rows="5" required="true"
												value="<?php echo $row['email']; ?>"> </div>
										<div class="form-group col-md-6"> <label for="exampleInputPassword1">Contact</label>
											<input type="number" id="contact" name="contact" class="form-control"
												placeholder="Cost" value="<?php echo $row['contact']; ?>" required="true">
										</div>

										<div class="form-group col-md-6"> <label for="exampleInputPassword1">Address</label>
											<input type="text" id="address" name="address" class="form-control"
												placeholder="Cost" value="<?php echo $row['address']; ?>" required="true">
										</div>
									<?php } ?>
									<div class="col-md-12">
