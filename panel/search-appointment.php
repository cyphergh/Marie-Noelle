...
if (strlen($_SESSION['bpmsaid'] == 0)) {
	...
	<head>
		<title>Marie Noelle Spa and Salon || Search Appointment</title>
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<div class="form-body">
								<form method="post" class="row" name="search" action="">
									...
									<div class="form-group col-md-6"> <label for="exampleInputEmail1">Search by Appointment
											Number / Contact number</label> <input id="searchdata" type="text"
