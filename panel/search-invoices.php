...
if (strlen($_SESSION['bpmsaid'] == 0)) {
	...
	<head>
		<title>Marie Noelle Spa and Salon || Search Invoice</title>
				...
				<div class="main-page">
					<div class="tables">
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<div class="form-body">
								<form method="post" class="row" name="search" action="">
									<p style="font-size:16px; color:red" align="center"> <?php if ($msg) {
										echo $msg;
									} ?> </p>


									<div class="form-group col-md-6"> <label for="exampleInputEmail1">Search by Invoice
											Number or Billing Number or Customer Name</label> <input id="searchdata"
											type="text" name="searchdata" required="true" class="form-control">
									</div>
