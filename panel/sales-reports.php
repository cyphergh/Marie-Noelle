				...
				<div class="main-page">
					<div class="forms">
						...
						<div class="form-grids row widget-shadow" data-example-id="basic-forms">
							...
							<div class="form-body">
								<form method="post" class="row" name="bwdatesreport" action="sales-reports-detail.php"
									...
									<div class="form-group col-md-6"> <label for="exampleInputPassword1">Request
											Type</label><br><input type="radio" name="requesttype" value="mtwise"
