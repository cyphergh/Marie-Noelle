	...
	<body class="cbp-spmenu-push">
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="tables">
						<h3 class="title1">Manage Order</h3>
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<table id="example" class="table table-bordered">
								...
								<tbody>
									<?php
									$ret = mysqli_query($con, "select * from  tblinvoice where type =1 group by Userid ");
									$cnt = 1;
									while ($row = mysqli_fetch_array($ret)) {
										...
										<tr>
											...
											<td>
												...
												$ret5 = mysqli_query($con, "select *from  tblcustomers where id ='" . $row['Userid'] . "' ");
												// $cnt=1;
