					...
					<div class="tables">
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<table id="example" class="table table-bordered">
								...
								<tbody>
									<?php
									$ret = mysqli_query($con, "SELECT s.name, COUNT(i.staff) AS service_count, SUM(i.total) AS total_sales
    FROM tblinvoice i
    JOIN tbl_staff s ON s.id = i.staff
    GROUP BY i.staff
